...
contract CCIP_Token_Sender is OwnerIsCreator {
	...
	constructor(address _router, address _link) {
		s_router = IRouterClient(_router); //Sepolia Router (CCIP) 0x0BF3dE8c5D3e8A2B34D2BEeB17ABfCeBaf363A59
		s_linkToken = IERC20(_link); //0x779877A7B0D9E8603169DdbD7836e478b4624789 Sepolia Link Address
